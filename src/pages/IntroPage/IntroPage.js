    ...
    <div className="intropage">
      <div className="container">
        ...
        <div className="row">
          ...
          <p>The Coffee House hiện là chuỗi cửa hàng đồ uống lớn nhất tại Việt Nam.
            Những sản phẩm từ The Coffee House đang như một cơn bão rất nhanh chóng lan rộng ra xung quanh những nước Châu Á.
